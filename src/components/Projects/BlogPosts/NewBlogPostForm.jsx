    ...
    >
      ...
      >
        <Form.Item
          name="title"
          label="Title"
          rules={[{ required: true, message: 'Please enter the BlogPost title' }]}
        >
          <Input placeholder="Enter BlogPost title" />
        </Form.Item>

        <Form.Item
          name="description"
          label="Description"
          rules={[{ required: true, message: 'Please enter the BlogPost description' }]}
        >
          <TextArea placeholder="Enter BlogPost description" />
        </Form.Item>

        <Form.Item
          name="BlogPost_type"
          label="BlogPost Type"
          rules={[{ required: true, message: 'Please select the BlogPost type' }]}
        >
          <Select placeholder="Select a BlogPost type">
