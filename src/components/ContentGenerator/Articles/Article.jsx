...
import { ContainerStyled, DivStyled, LogoAnimation, DivHeader } from './styles';
  ...
  const items = [
	{
	  label: 'Outline  Article',
	  key: '1',
	  icon: <SearchOutlined />,
	},
	{
	  label: 'Chapter to Article',
	  key: '2',
	  icon: <SearchOutlined />,
	},
	{
	  label: 'Section to Article',
	  key: '3',
	  icon: <SearchOutlined />,
	},
	{
	  label: 'Format as Article',
	  key: '4',
	  icon: <SearchOutlined />,
	},
  ];
...
const Article = () => {
	...
	const handleMenuClick = (e) => {
		if(e.key==='1')
		continuePrompt('Outline  Article:'+search);
		if(e.key==='2')
		continuePrompt('Chapter to Article'+search);
		if(e.key==='3')
		continuePrompt('Section to Article'+search);
		if(e.key==='4')
		continuePrompt('Format as Article'+search);
	  };
	const menuProps = {
		items,
