...
import { ContainerStyled, DivStyled, LogoAnimation, DivHeader } from './styles';
  ...
  const items = [
	...
	{
	  label: 'Chapter to Email',
	  key: '2',
	  icon: <SearchOutlined />,
	},
	{
	  label: 'Section to Email',
	  key: '3',
	  icon: <SearchOutlined />,
	},
	{
...
const Email = () => {
	...
	const handleMenuClick = (e) => {
		if(e.key==='1')
		continuePrompt('Outline  Email:'+search);
		if(e.key==='2')
		continuePrompt('Chapter to Email'+search);
		if(e.key==='3')
		continuePrompt('Section to Email'+search);
		if(e.key==='4')
		continuePrompt('Format as Email'+search);
	  };
	const menuProps = {
		items,
	...
	return (
		...
		<DivStyled>
			<DivHeader >
				<h2 ><LogoAnimation></LogoAnimation>AI Email Generator </h2>
			</DivHeader>
			<ContainerStyled >
			{contextHolder}
